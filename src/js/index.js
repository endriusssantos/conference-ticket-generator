...
function validateFile(input, hint) {
    ...
    if (!file) {
        ...
        if (!validTypes.includes(file.type)) {
            hint.classList.add('error');
            hint.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16"> <path stroke="#f57261" stroke-linecap="round" stroke-linejoin="round" d="M2 8a6 6 0 1 0 12 0A6 6 0 0 0 2 8Z" /><path fill="#f57261" d="M8.004 10.462V7.596ZM8 5.57V-.042Z" /><path stroke="#f57261" stroke-linecap="round" stroke-linejoin="round" d="M8.004 10.462V7.596M8 5.569V-.042" /></svg> Invalid filetype upload a JPG or PNG photo.';
            input.value = '';
            isValid = false;
        } else if (file.size > maxSize) {
            hint.classList.add('error');
            hint.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16"> <path stroke="#f57261" stroke-linecap="round" stroke-linejoin="round" d="M2 8a6 6 0 1 0 12 0A6 6 0 0 0 2 8Z" /><path fill="#f57261" d="M8.004 10.462V7.596ZM8 5.57V-.042Z" /><path stroke="#f57261" stroke-linecap="round" stroke-linejoin="round" d="M8.004 10.462V7.596M8 5.569V-.042" /></svg> File too large. Please upload a photo under 500KB.';
            input.value = '';
            isValid = false;
        } else {
            hint.classList.remove('error');
            hint.innerHTML = '<img src="./src/images/icon-info.svg" alt="info icon"/> Upload your photo (JPG or PNG, max size: 500KB).';
...
function resetUpload() {
    const defaultUploadIcon = './src/images/icon-upload.svg';
    ...
    uploadHint.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16"> <path stroke="#f57261" stroke-linecap="round" stroke-linejoin="round" d="M2 8a6 6 0 1 0 12 0A6 6 0 0 0 2 8Z" /><path fill="#f57261" d="M8.004 10.462V7.596ZM8 5.57V-.042Z" /><path stroke="#f57261" stroke-linecap="round" stroke-linejoin="round" d="M8.004 10.462V7.596M8 5.569V-.042" /></svg> Upload your photo (JPG or PNG, max size: 500KB).';
};
